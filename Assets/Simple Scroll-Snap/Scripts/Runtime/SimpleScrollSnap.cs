...
namespace DanielLochner.Assets.SimpleScrollSnap
{
    ...
    public class SimpleScrollSnap : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler, IPointerDownHandler, IPointerUpHandler
    {
        ...
        public void AddToFront(GameObject panel, bool instatiate = true)
        {
            Add(panel, 0, instatiate);
        }
        public void AddToBack(GameObject panel, bool instatiate = true)
        {
            Add(panel, NumberOfPanels, instatiate);
        }
